...
/// Load, migrate, then run the fixers — the forced-upgrade path, which the
/// migration tests use to exercise [`epubfix::migrate_book`]'s mechanics
/// regardless of what the default retagging would decide.
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="BookId">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    <dc:identifier id="BookId" opf:scheme="UUID">urn:uuid:12345678-1234-4234-8234-123456789012</dc:identifier>
    <dc:title>Test</dc:title><dc:language>en</dc:language>
