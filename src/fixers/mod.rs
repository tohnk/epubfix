...
pub fn all(opts: &crate::Options) -> Vec<Box<dyn Fixer>> {
    vec![
        ...
        Box::new(opf::SpineToc),
        Box::new(opf::ReservedPrefix),
        ...
        Box::new(opf::LegacyOpfAttrs),
        Box::new(opf::DanglingRefines),
        ...
        Box::new(ncx::DtbUid),
        Box::new(ncx::SpineOrder),
        Box::new(ncx::NavOrder),
